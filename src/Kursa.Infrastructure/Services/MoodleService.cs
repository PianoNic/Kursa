    ...
    ILogger<MoodleService> logger) : IMoodleService
{
        ...
        string moodleToken, CancellationToken cancellationToken = default)
    {
        ...
        var body = new Get_user_courses_params { MoodleUrl = moodleOptions.Value.SiteUrl, Token = moodleToken };
        ...
        string moodleToken, int courseId, CancellationToken cancellationToken = default)
    {
        ...
        var response = await client.Core.Course.GetContents.PostAsync(
            new Get_course_contents_params { MoodleUrl = moodleOptions.Value.SiteUrl, Token = moodleToken, Courseid = courseId }, cancellationToken: cancellationToken);
        ...
        string moodleToken, CancellationToken cancellationToken = default)
    {
        ...
        var response = await client.Core.Webservice.GetSiteInfo.PostAsync(
            new Get_site_info_params { MoodleUrl = moodleOptions.Value.SiteUrl, Token = moodleToken }, cancellationToken: cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var client = clientFactory.CreateForToken(moodleToken);
        var body = new Get_assignments_params { MoodleUrl = moodleOptions.Value.SiteUrl, Token = moodleToken };
        ...
        string moodleToken, int courseId, CancellationToken cancellationToken = default)
    {
        ...
        var response = await client.Gradereport.User.GetGradeItems.PostAsync(
            new Get_grade_items_params { MoodleUrl = moodleOptions.Value.SiteUrl, Token = moodleToken, Courseid = courseId }, cancellationToken: cancellationToken);
        ...
        string moodleToken, int courseId, CancellationToken cancellationToken = default)
    {
        ...
        var client = clientFactory.CreateForToken(moodleToken);
        var body = new Get_forums_by_courses_params { MoodleUrl = moodleOptions.Value.SiteUrl, Token = moodleToken };
        ...
        string moodleToken, int forumId, CancellationToken cancellationToken = default)
    {
        ...
        var response = await client.Mod.Forum.GetForumDiscussions.PostAsync(
            new Get_forum_discussions_params { MoodleUrl = moodleOptions.Value.SiteUrl, Token = moodleToken, Forumid = forumId }, cancellationToken: cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var client = clientFactory.CreateForToken(moodleToken);
        var body = new Get_calendar_events_params { MoodleUrl = moodleOptions.Value.SiteUrl, Token = moodleToken };
